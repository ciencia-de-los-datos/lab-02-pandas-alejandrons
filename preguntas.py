...
def pregunta_06():
    ...
    """
    return sorted(map(str.upper,set(tbl1["_c4"])))
...
def pregunta_09():
    ...
    """
    # Ojo, año bisiesto en la fila 35, error por intentar convertir a fecha
...
def pregunta_12():
    ...
    """
    combinacion = pd.merge(tbl0, tbl2, on='_c0')
    combinacion["_c5b"] = combinacion["_c5b"].apply(lambda x: str(x))
...
def pregunta_13():
    ...
    """
    combinacion = pd.merge(tbl0, tbl2, on='_c0')
    return combinacion.groupby('_c1')['_c5b'].sum()
